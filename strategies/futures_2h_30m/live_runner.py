...
#         Module-level guard and allocator instances are
#         kept as fallback for standalone execution only
#         (when this file is run directly as __main__).
#         When called from scanner.py, the shared instances
#         are used so both strategies see the same state.
#
#   F11 - Price validation added before calculate_position_size.
#         If latest_price is None, NaN, or <= 0, the symbol
#         is skipped with a log message. Prevents silent
#         fallback to 1 lot caused by NaN price input.
# ============================================================
